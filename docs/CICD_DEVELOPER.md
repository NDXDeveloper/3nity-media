...
| `https://ffmpeg.org/releases/ffmpeg-6.1.tar.xz` | Active | FFmpeg source (Flatpak) |
| `https://github.com/mpv-player/mpv/archive/refs/tags/v0.37.0.tar.gz` | Active | MPV source (Flatpak) |
